...
public class TestDblayer {
    public static void main(String[] args) {
        ...
        System.out.println("Messages mellan 1 och 2: "+DBFacade.getMessagesBetweenUsers(1,3));
        System.out.println("Messages mellan 2 och 1: "+DBFacade.getMessagesBetweenUsers(3,1));
